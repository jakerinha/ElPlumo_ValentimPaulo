...
import { Animated, Dimensions, StyleSheet, Text, View, SafeAreaView, Settings, Button } from 'react-native';
...
export default function Home({navigation}) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      />
      <Button title="Medições" onPress={()=> navigation.navigate('Medições')}/>
      <View
        style={{
          position: 'absolute',
          border: 0,
